    ...
    <div style="border: 1px solid rgb(37, 72, 142);" class="mb-2">
        ...
        <form class="col-8 mx-auto p-2" action="{{url('home/admin/agregar')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="custom-select custom-select-sm @error('correcta') is-invalid @enderror" name="correcta" required value="{{ old('correcta') }}">
            ...
            <div class="form-group p-2">
                <select class="custom-select custom-select-sm @error('category') is-invalid @enderror" name="category" required value="{{ old('category') }}">
